...
# 💫 About Me:
### 💫 About Me<br>**Principal Data Engineer & Data Platform Architect** | 7+ Years Engineering High-Integrity Infrastructure<br><br>I engineer resilient, high-integrity data platforms required to transition AI/ML models from experimental pilots to production-grade workloads. My expertise spans Medallion Lakehouse Architectures, automated SLA validation gates, and Infrastructure as Code on AWS.<br><br>#### 📈 Strategic Impact Metrics<br>• **70% Reduction in Data Reconciliation Incidents**: Standardized ACID transactions on regional airspace datasets via Apache Iceberg.<br>• **95% Quality SLA Maintenance**: Established automated validation gates for TB-scale AI and ML training datasets.<br>• **22% AWS Monthly Cost Reduction**: Optimized infrastructure via Terraform-managed Glue workers and columnar Parquet partitioning.<br>• **40% Reduction in Operational Overhead**: Automated orchestration workflows with Apache Airflow (MWAA) and containerized recovery sidecars.<br>• **30% Reduction in Deployment Errors**: Standardized release pipelines via GitLab CI/CD and dependency controls.<br><br>#### 🛠️ Technical Focus<br>• **Architectural Frameworks**: Medallion Architecture (Bronze/Silver/Gold), Lakehouse Design, Data Governance, GDPR Compliance<br>• **Core Data Stack**: Apache Iceberg, PySpark, PostgreSQL, DuckDB, MinIO<br>• **Cloud & Infrastructure**: AWS (S3, Glue, Athena, MWAA), Terraform, Docker, GitLab CI/CD, Linux, Bash


## 🌐 Socials:
[![Discord](https://img.shields.io/badge/Discord-%237289DA.svg?logo=discord&logoColor=white)](https://discord.gg/graceirungu_05305) [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/https://www.linkedin.com/in/grace-w-irungu/) [![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/https://x.com/sharkynahjames1) 
